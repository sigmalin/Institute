Shader "Urp/UrpSkinToonShader"
{
    Properties
    {
        ...
        _Scatter("Scatter Amt", Range(0.0001, 1)) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float SphericalGaussian(float x, float sharpness)
            {
                return exp(sharpness * (x - 1));
            }
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                float ss = SphericalGaussian(NdotL, _Scatter);
                ...
                color.rgb += ss * _ScatterColor.rgb;
