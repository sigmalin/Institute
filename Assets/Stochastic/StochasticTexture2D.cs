...
[Serializable]
[CreateAssetMenu(fileName = "New Stochastic Texture 2D", menuName = "", order = 1)]
public class StochasticTexture2D : ScriptableObject
{
    ...
    public CompressionLevel compressionQuality = StochasticTexture2D.CompressionLevel.HighQuality;
